...
def cmd_list(args, storage: BragStorage):
    if args.date:
        ...
        entries = storage.get_entries_range(start_date.isoformat(), end_date.isoformat())
...
def main():
    ...
    export_parser.add_argument("--format", choices=["json", "markdown", "text"], default="json", help="Output format")
